...
Single click delete for Cisco ASAv Cluster Stacks for AWS
...
control_delete = '4'
#set to '1' to delete only ASAv stack
#set to '2' to delete ASAv stack and empty s3 bucket of infrastructure stack
#set to '3' to delete ASAv stack, s3 bucket, and infrastructure stack
#set to '4' to delete ASAv stack, s3 bucket, infrastructure stack and the
...
while control_delete not in ['1','2','3','4']:
	...
	print('Enter 3 to delete ASAv stack, s3 bucket, and infrastructure stack')
	control_delete = str(input(
		"Enter 4 to delete ASAv stack, s3 bucket, infrastructure stack" +
...
input('press enter to delete stack: ' + asav_stack_name + ' or CTRL+C to quit')

v.cf_template.delete_stack(StackName=asav_stack_name)
...
print('ASAv stack deleted succesfully')
