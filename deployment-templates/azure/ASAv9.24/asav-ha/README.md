...
[Azure ASAv HA configuration](https://www.cisco.com/c/en/us/td/docs/security/asa/asa924/configuration/general/asa-924-general-config/ha-failover-cloud.html)

[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FCiscoDevNet%2Fcisco-asav%2Fmaster%2Fdeployment-templates%2Fazure%2FASAv9.24%2Fasav-ha%2Fazure-asav-ha-custom-template.json)
...
21. **vmSize**: The VM size to use for the ASAv HA. Standard_DS3_v2 is the default.<br>
...
22. **location**: This shouldn't be changed and should always be set to the below value.<br>
resourceGroup().location

23. **baseStorageURI**: This is used to fetch the storage account and should always be set to the below value.<br>
.blob.core.windows.net

24. **publicInboundPorts**: Whether public inbound ports are allowed or not.<br>
e.g. None or AllowSelectedPorts

25. **selectedInboundPorts**: Selected public inbound ports to be allowed in network security group.<br>
e.g. ["22", "443"]

26. **enableSecureBoot**: Enable Secure Boot for the VM (Trusted Launch feature).<br>
