...
[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FCiscoDevNet%2Fcisco-asav%2Fmaster%2Fdeployment-templates%2Fazure%2FASAv9.24%2Fasav-ipv6-custom-image-template%2Fasav-ipv6-custom-image-template.json)
...
33. **vmSize**: The VM size to use for the ASAv. Standard_DS3_v2 is the default.<br>
...
34. **publicInboundPorts**: Whether public inbound ports are allowed or not.<br>
e.g. None or AllowSelectedPorts

35. **selectedInboundPorts**: Selected public inbound ports to be allowed in network security group.<br>
e.g. ["22", "443"]

36. **enableSecureBoot**: Enable Secure Boot for the VM (Trusted Launch feature).<br>
e.g. false

37. **location**: This shouldn't be changed and should always be set to the below value.<br>
resourceGroup().location

38. **baseStorageURI**: This is used to fetch the storage account and should always be set to the below value.<br>
